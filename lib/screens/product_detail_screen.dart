  ...
  Widget _buildProductImage() {
    ...
    return AspectRatio(
      ...
      child: Container(
        ...
        child: Image.asset(
          'images/SepatuSamba.jpg', // <-- Path sesuai deklarasi di pubspec.yaml
          fit:
              BoxFit
                  .cover, // <-- Penting: Mengatur bagaimana gambar mengisi ruang
          ...
          // dll.
          semanticLabel: 'Sepatu Formal', // Deskripsi untuk aksesibilitas
        ),
      ),
    );
  }
  ...
  Widget _buildOptionsSelector(
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(spacing: 10.0, runSpacing: 6.0, children: options),
      ],
    );
  }
  ...
  Widget _buildProductInfo(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Sepatu Formal Samba Black Gum Edition',
            style: Theme.of(
              context,
          ...
          const SizedBox(height: 8.0),
          Text(
            'Adidas Samba adalah sepatu klasik yang pertama kali dirilis pada tahun 1950-an oleh Adidas. Awalnya dirancang sebagai sepatu sepak bola dalam ruangan, namun seiring waktu, Samba menjadi ikon mode streetwear karena desainnya yang timeless dan serbaguna',
            style: Theme.of(context).textTheme.bodyMedium?.copyWith(
        ...
        children: [
          Padding(
            ...
            child: ClipRRect(
              ...
              child:
                  _buildProductImage(), // <-- Memanggil gambar yang sudah diperbarui
            ),
          ),
