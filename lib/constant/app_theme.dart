...
class AppTheme {
  ...
  static final Color _seedColor =
      Colors.teal; // Contoh: Ganti dengan warna lain
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      // Tambahkan tema untuk OutlinedButton
    ...
    chipTheme: ChipThemeData(
      ...
      backgroundColor:
          Colors
              .grey
              .shade200, // WARNA LATAR untuk chip TIDAK TERPILIH (abu terang)
      selectedColor: _seedColor, // Warna latar untuk chip TERPILIH (warna tema)
      disabledColor:
          Colors.grey.shade300, // Warna jika chip dinonaktifkan (opsional)
      // --- Warna Teks (Label) ---
      labelStyle: TextStyle(
        // Gaya teks saat chip TIDAK TERPILIH
        fontSize: 14,
        fontWeight: FontWeight.w500,
        color:
            Colors
                .black87, // << Warna teks gelap agar terbaca di background abu terang
      ),
      secondaryLabelStyle: TextStyle(
        // Gaya teks saat chip TERPILIH
        fontSize: 14,
        fontWeight: FontWeight.w500,
        color:
            Colors
                .white, // << Warna teks putih agar kontras di background warna tema
      ),
